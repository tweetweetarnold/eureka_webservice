...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Monthly Spending for ${sessionScope.name}</h1>
					<!-- breadcrumb -->
					<ol class="breadcrumb">
						<li class="active">Monthly Spending</li>
						<li>
							<a href="/eureka_webservice/LoadAdminViewCompanyWeeklySpending?company=${param.company}&name=${sessionScope.name}">Weekly Spending</a>
						</li>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<form class="sign-in-up-form"
						action="/eureka_webservice/LoadAdminViewCompanyMonthlySpending"
						role="form">
						<div class="col-md-2">
					...
					<center>
						<img
							src="/eureka_webservice/LoadCompanyMonthlyChart?year=${yearValue}&company=${param.company}" />
					</center>
					<br>
					<br>

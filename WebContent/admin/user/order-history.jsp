							...
							<div class="panel panel-default">
								...
								>
									<div class="panel-body">
										...
										<br>
										Discount:
										<fmt:formatNumber value="${orderHistory.totalPriceBeforePriceModifiers - orderHistory.finalPrice}"
											var="discount" minFractionDigits="2"
										/>
										$${discount}
										<br>
										Amount Payable:
										<fmt:formatNumber value="${orderHistory.finalPrice}" var="payable" minFractionDigits="2" />

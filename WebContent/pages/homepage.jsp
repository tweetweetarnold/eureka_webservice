...
<body>
	...
	<!-- 		url('http://placehold.it/1900x1080&amp;amp;text=Slide One');"></div> -->
	...
	<!-- 			<div class="item"> -->
	<!-- 				<div class="fill" style="background-image: -->
	<!-- 		url('http://placehold.it/1900x1080&amp;amp;text=Slide Two');"></div> -->
	<!-- 				<div class="carousel-caption"> -->
	<!-- 					<h2>Caption 2</h2> -->
	<!-- 				</div> -->
	<!-- 			</div> -->
	<!-- 			<div class="item"> -->
	<!-- 				<div class="fill" style="background-image: -->
	<!-- 		url('http://placehold.it/1900x1080&amp;amp;text=Slide Three');"></div> -->
	<!-- 				<div class="carousel-caption"> -->
	<!-- 					<h2>Caption 3</h2> -->
	<!-- 				</div> -->
	<!-- 			</div> -->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Stalls</h2>
			</div>

	...
	public static void main(String[] args) {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,
					InternetAddress.parse("boonhui.koh.2013@sis.smu.edu.sg"));
			message.setSubject("My First Email");
			String msg = "Dear user,</br>"
					+ "We are happy to grant you access to NEC Monitoring Health Application.</br>Please login with the below: </br>Username: "
					+ username + "</br> Password: " + password
					+ "</br> We hope that you will find our apps useful.</br> Thank you."

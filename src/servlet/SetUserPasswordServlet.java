...
/**
 * Servlet implementation class SetUserPasswordServlet
 */
@WebServlet("/SetUserPasswordServlet")
public class SetUserPasswordServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SetUserPasswordServlet() {
		super();

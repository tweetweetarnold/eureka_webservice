...
public class SendNotification implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			String messageBody = "Dear User,<br><br>" + "A new order period is now available!<br><br>" + "<a href="
			...
			OrderPeriod orderPeriod = orderPeriodController.getOrderPeriod(Integer.parseInt(orderPeriodId));

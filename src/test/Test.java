...
public class Test {
	...
	public static void main(String[] args) {
		...
		Company company2 = new Company("Eastman Chemical", "ECM901",
				new HashSet<String>(Arrays.asList("FEEDSTOCK", "PSN", "CONTROL", "MAINTENANCE")));
		...
		Admin admin = new Admin("admin", a.encrypt("1234567"), "admin1", 45678925);
		session.save(admin);
		...
		Food nfood1 = new Food("Fish Head Soup and Beehoon", "鱼头米粉汤", "add veg $0.50", 4.20, null,
				null, stall1);
		Food nfood2 = new Food("Fish Soup", "鱼汤", "add veg $0.50", 4.20,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458374052/Food%20Images%20Raw/Fish_soup.jpg",
				null, stall1);
		Food nfood3 = new Food("Fried Fish Soup and Beehoon", "炸鱼汤米粉", "add veg $0.50", 3.70,
				...
				null, stall1);
		Food nfood4 = new Food("Fish Soup and Beehoon", "鱼汤米粉", "add veg $0.50", 3.70,
		...
		Modifier modifierNew2 = new Modifier("Add Veg", "加菜", "", 0.50, food2);
		...
		Modifier modifierNew3 = new Modifier("Add Veg", "加菜", "", 0.50, nfood1);
		...
		Modifier modifierNew4 = new Modifier("Add Veg", "加菜", "", 0.50, nfood2);
		...
		Modifier modifierNew5 = new Modifier("Add Veg", "加菜", "", 0.50, nfood3);
		...
		Modifier modifierNew6 = new Modifier("Add Veg", "加菜", "", 0.50, nfood4);
		...
		Food food3 = new Food("Chilli Chicken + Veg", "辣椒鸡加菜", "upsize to $3.50", 3.00,
		...
		Food food5 = new Food("Curry Fish + Veg", "咖喱鱼加菜", "upsize to $3.50", 3.00,
		...
		Food food6 = new Food("1 Meat + 2 Veg", "1肉2菜", "", 3.00,
				...
				null, stall3);
		Food food7 = new Food("All Veg", "全菜", "", 3.00,
		...
		Modifier modifierMixed2 = new Modifier("Add Veg", "加菜", "", 0.50, food7);
		...
		Food nfood6 = new Food("Mutton Briyani", "马来羊肉饭", "", 4.00,
		...
		Modifier modifierNew14 = new Modifier("Add charsiew", "加叉烧", "", 1.00, food13);
		Modifier modifierNew15 = new Modifier("Add roast meat", "加烧肉", "", 1.00, food13);
		...
		Modifier modifierNew16 = new Modifier("Add roast chicken", "加烧鸡", "", 1.00, food14);
		Modifier modifierNew17 = new Modifier("Add roast meat", "加烧肉", "", 1.00, food14);
		...
		Modifier modifierNew18 = new Modifier("Add roast chicken", "加烧鸡", "", 1.00, food15);
		Modifier modifierNew19 = new Modifier("Add charsiew", "加叉烧", "", 1.00, food15);
		...
		Food food20 = new Food("Seafood Horfun(Wet)", "海鲜河粉（湿）", "", 3.50,
				"resources/img/food/img-seafoodhorfun.jpg", null, stall7);
		Food food21 = new Food("Seafood Horfun(Dry)", "海鲜河粉（干）", "", 4.00,
				"resources/img/food/img-horfun.jpg", null, stall7);
		Food food22 = new Food("Chicken Porridge", "鸡肉粥", "", 3.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627120/Food%20Images%20Raw/porridge.jpg",
				null, stall7);
		Food food23 = new Food("Fish Porridge", "鱼粥", "", 3.00,
				"resources/img/food/img-fishporridge.jpg", null, stall7);
		Food foodA24 = new Food("Chicken Horfun(Wet)", "鸡肉河粉（汤）", "", 3.50,
				"resources/img/food/img-chickenhorfunwet.jpg", null, stall7);
		Food foodA25 = new Food("Chicken Horfun(Dry)", "鸡肉河粉（干）", "", 4.00,
				"resources/img/food/img-chickenhorfundry.jpg", null, stall7);

		Food nfood15 = new Food("Chicken Horfun(Gravy)", "鸡肉河粉（淋汁）", "", 3.50, null, null, stall7);
		Food nfood16 = new Food("Chicken Beehoon(Gravy)", "鸡肉米粉（淋汁）", "", 3.50, null, null, stall7);

		Food nfood17 = new Food("Chicken Horfun(Fried)", "鸡肉河粉（炒）", "", 4.00, null, null, stall7);
		Food nfood18 = new Food("Chicken Beehoon(Fried)", "鸡肉米粉（炒）", "", 4.00, null, null, stall7);

		Food nfood19 = new Food("Seafood Horfun(Gravy)", "海鲜河粉（淋汁）", "", 3.50, null, null, stall7);
		Food nfood20 = new Food("Seafood Beehoon(Gravy)", "海鲜米粉（淋汁）", "", 3.50, null, null, stall7);

		Food nfood21 = new Food("Seafood Horfun(Fried)", "海鲜河粉（炒）", "", 4.00, null, null, stall7);
		Food nfood22 = new Food("Seafood Beehoon(Fried)", "海鲜河粉（炒）", "", 4.00, null, null, stall7);

		Food nfood23 = new Food("Beef Horfun(Gravy)", "牛肉河粉（淋汁）", "", 4.00, null, null, stall7);
		Food nfood24 = new Food("Beef Beehoon(Gravy)", "牛肉米粉（淋汁）", "", 4.00, null, null, stall7);

		Food nfood25 = new Food("Beef Horfun(Fried)", "牛肉河粉（炒）", "", 4.00, null, null, stall7);
		Food nfood26 = new Food("Beef Beehoon(Fried)", "牛肉米粉（炒）", "", 4.00, null, null, stall7);

		Food nfood27 = new Food("Chicken Rice(Chicken Breast)", "鸡饭（鸡胸肉）", "", 3.00, null, null,
				stall7);

		Food nfood28 = new Food("Chicken Rice(Chicken Thigh)", "鸡饭（鸡腿肉）", "", 3.00, null, null,
				stall7);

		Food nfood29 = new Food("Chicken Rice(Drumstick)", "鸡饭（鸡腿）", "", 3.50, null, null, stall7);
		...
		Modifier modifierFriedRice14 = new Modifier("Chicken", "鸡肉", "", 0.00, food17);
		Modifier modifierFriedRice15 = new Modifier("Seafood", "海鲜", "", 0.50, food17);
		Modifier modifierFriedRice16 = new Modifier("Beef", "牛肉", "", 1.00, food17);
		...
		Stall stall8 = new Stall("Vegetarian Stall", 91182963, null, null,
				"resources/img/stall/img-tj.jpg", null);
		Food food24 = new Food("Vegetarian Rice", "斋饭", "add veg $0.50", 2.50,
		...
		Food nfood7 = new Food("Vegetarian Kway Tiao", "素粿条", "add veg $0.50", 2.50,
				...
				null, stall8);
		Food nfood8 = new Food("Vegetarian Beehoon Kway Tiao", "素米粉粿条", "add veg $0.50", 2.50, null,
				null, stall8);
		...
		Modifier modifierNew8 = new Modifier("Add Veg", "加菜", "", 0.50, food25);
		...
		Modifier modifierNew9 = new Modifier("Add Veg", "加菜", "", 0.50, food26);
		...
		Modifier modifierNew10 = new Modifier("Add Veg", "加菜", "", 0.50, nfood7);
		...
		Modifier modifierNew11 = new Modifier("Add Veg", "加菜", "", 0.50, nfood8);
		...
		Food food27 = new Food("Minced Meat Noodles(Mee Kia)", "肉挫面（面仔）", "upsize to $3.20", 2.70,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458037674/Food%20Images%20Raw/minced_meat_noodle_mee_kia.jpg",
				null, stall9);
		...
		Food nfood9 = new Food("Minced Meat Noodles(Mee Pok)", "肉挫面（面薄）", "upsize to $3.20", 2.70,
				...
				null, stall9);
		Food nfood10 = new Food("Minced Meat Noodles(Mee Tai Mak)", "肉挫面（米台目）", "upsize to $3.20",
				2.70, null, null, stall9);
		...
		Modifier modifierNew12 = new Modifier("Upsize to $3.20", "加大", "", 0.50, nfood9);
		...
		Modifier modifierNew13 = new Modifier("Upsize to $3.20", "加大", "", 0.50, nfood10);
		...
		// food28 modifiers
		Modifier noodleStallModifier1 = new Modifier("Thin Beehoon", "幼米粉", "", 0.00, food28);
		Modifier noodleStallModifier2 = new Modifier("Thick Beehoon", "粗米粉", "", 0.00, food28);
		Modifier noodleStallModifier3 = new Modifier("Yellow Noodles", "黄面", "", 0.00, food28);
		...
		// food30 modifiers
		Modifier noodleStallModifier4 = new Modifier("Thin Beehoon", "幼米粉", "", 0.00, food30);
		Modifier noodleStallModifier5 = new Modifier("Thick Beehoon", "粗米粉", "", 0.00, food30);
		Modifier noodleStallModifier6 = new Modifier("Yellow Noodles", "黄面", "", 0.00, food30);
		...
		Food food37 = new Food("Watermelon Juice", "西瓜汁", "", 2.50,
		...
		Food food39 = new Food("Dragonfruit Juice", "龙珠果汁", "", 2.50,
		...
		Food food41 = new Food("Pear Juice", "梨汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458037645/Food%20Images%20Raw/Pear_juice_2.jpg",
				null, stall11);

		Food food42 = new Food("Honeydew", "哈蜜瓜", "", 0.70, "resources/img/food/img-honeydew.jpg",
				null, stall11);

		Food food43 = new Food("Honeydew Juice", "哈蜜瓜汁", "", 2.50,
		...
		Food food45 = new Food("Papaya Juice", "木瓜汁", "", 2.60,
		...
		Food food47 = new Food("Pineapple Juice", "黄梨汁", "", 2.50,
		...
		Food food49 = new Food("Banana Juice", "香蕉汁", "", 2.60,
		...
		Food food54 = new Food("Guava Juice", "番石榴汁", "", 2.50,
		...
		Food food56 = new Food("Sarawak Pineapple Juice", "沙捞越黄梨汁", "", 3.10,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1457059123/Food%20Images%20Raw/Pineapple_juice.jpg",
				null, stall11);
		...
		Modifier modifierNew23 = new Modifier("Add powder", "加酸梅粉", "", 0.00, food53);
		...
		Food mfood2 = new Food("Asam Fish + Veg", "亚叁鱼加菜", "more vegs, less fried meat", 3.70,
				...
				null, malayStall);
		Food mfood3 = new Food("Curry Fish + Veg", "咖喱鱼加菜", "more vegs, less fried meat", 3.70,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627012/Food%20Images%20Raw/curry_fish_plus_veg.jpg",
				null, malayStall);
		// Food mfood4 = new Food("Beef + Veg", "more vegs, less fried meat",
		// 3.70,
		// "resources/img/food/img-malaybeef.jpg", malayStall);
		Food mfood5 = new Food("Fried Chicken + Veg", "炸鸡加菜", "more vegs, less fried meat", 3.70,
				"resources/img/food/img-malayfriedchicken.jpg", null, malayStall);
		Food mfood6 = new Food("Fried Fish + Veg", "炸鱼加菜", "more vegs, less fried meat", 3.70,
		...
		Food infood2 = new Food("White Rice(Fish)", "白饭（鱼肉）", "Chicken/Fish/Mutton", 4.00,
				"resources/img/food/img-whiterice.jpg", null, indianStall);
		Food infood3 = new Food("White Rice(Mutton)", "白饭（羊肉）", "Chicken/Fish/Mutton", 4.00,
				"resources/img/food/img-whiterice.jpg", null, indianStall);
		Food infood4 = new Food("Vegetable White Rice", "菜白饭", "", 3.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627145/Food%20Images%20Raw/vegetable_white_rice.jpg",
				null, indianStall);
		Food infood5 = new Food("Chicken Briyani", "马来鸡肉饭", "Chicken", 5.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627030/Food%20Images%20Raw/chicken_briyani.jpg",
				null, indianStall);
		Food infood6 = new Food("Fish Briyani", "马来鱼肉饭", "Fish", 5.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627097/Food%20Images%20Raw/Fish_Briyani.jpg",
				null, indianStall);
		Food infood7 = new Food("Mutton Briyani", "马来羊肉饭", "Mutton", 5.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627086/Food%20Images%20Raw/mutton_briyani.jpg",
				null, indianStall);
		...
		Modifier modifierI3 = new Modifier("More vegetables", "多菜", "", 0.5, infood3);
		Modifier modifierI4 = new Modifier("More vegetables", "多菜", "", 0.5, infood4);
		Modifier modifierI5 = new Modifier("More vegetables", "多菜", "", 0.5, infood5);
		Modifier modifierI6 = new Modifier("More vegetables", "多菜", "", 0.5, infood6);
		Modifier modifierI7 = new Modifier("More vegetables", "多菜", "", 0.5, infood7);
		Modifier modifierI8 = new Modifier("More vegetables", "多菜", "", 0.5, infood8);
		...
		Food mixVegRice5 = new Food("Porridge(All Veg)", "粥（全菜）", "", 3.20, null, null,
				chineseMixVegStall);
		...
		Modifier modifierMV2 = new Modifier("Upsize to $3.20", "加大", "", 0.20, mixVegRice2);
		...
		Food roastfood2 = new Food("Wanton Mee(Dry)", "云吞面（干）", "", 3.20,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458037657/Food%20Images%20Raw/wanton_mee_dry.jpg",
				null, roastMeatStall);
		...
		Modifier modifier13 = new Modifier("Add roast meat", "加烧肉", "", 1.00, roastfood1);
		...
		Modifier modifier14 = new Modifier("Add roast chicken", "加烧鸡", "", 1.00, roastfood3);
		Modifier modifier15 = new Modifier("Add roast meat", "加烧肉", "", 1.00, roastfood3);
		...
		Modifier modifier16 = new Modifier("Add charsiew", "加叉烧", "", 1.00, roastfood4);
		Modifier modifier17 = new Modifier("Add roast chicken", "加烧鸡", "", 1.00, roastfood4);
		...
		Food seafood2 = new Food("Fried Rice", "炒饭", "", 4.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627008/Food%20Images%20Raw/chicken_fried_rice.jpg",
				null, seafoodTzeCharStall);
		Food seafood3 = new Food("Horfun (Wet)", "河粉（湿）", "", 3.70, null, null,
				seafoodTzeCharStall);
		Food seafood4 = new Food("Hokkien Noodle", "福建面", "", 4.20,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627077/Food%20Images%20Raw/hokkien_mee.jpg",
				null, seafoodTzeCharStall);
		Food seafood5 = new Food("Mee Goreng", "炒面", "", 4.20,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627087/Food%20Images%20Raw/mee_goreng.jpg.png",
				null, seafoodTzeCharStall);
		Food seafood6 = new Food("Ginger & Onion Fish", "姜葱鱼", "", 4.50,
				"resources/img/food/img-gingeronionfishrice.jpg", null, seafoodTzeCharStall);
		Food seafood7 = new Food("Dried Chilli Chicken", "干辣椒鸡", "", 4.50,
				"resources/img/food/img-driedchillichicken.jpg", null, seafoodTzeCharStall);
		Food seafood8 = new Food("Sweet & Sour Pork", "酸甜猪肉", "", 4.50,
		...
		Food seafood9 = new Food("Pork Rib Soup", "排骨汤", "", 4.80,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/c_fill,h_169,w_263/v1457808872/Food%20Images%20Raw/pork_rib_soup.jpg",
				null, seafoodTzeCharStall);
		Food seafood10 = new Food("Black Chicken Soup", "黑鸡汤", "", 5.80,
				...
				null, seafoodTzeCharStall);
		Food seafood11 = new Food("White Chicken Soup", "白鸡汤", "", 5.50,
				"resources/img/food/img-whitechickensoup.jpg", null, seafoodTzeCharStall);

		Set<Modifier> modifierListS9 = new HashSet<Modifier>();
		Modifier modifierS91 = new Modifier("Water Crest", "西洋菜", "", 0.00, seafood9);
		Modifier modifierS92 = new Modifier("Old Cucumber", "老黄瓜", "", 0.00, seafood9);
		Modifier modifierS93 = new Modifier("White Carrot", "白萝卜", "", 0.00, seafood9);
		Modifier modifierS94 = new Modifier("Lotus Root", "莲藕", "", 0.00, seafood9);
		Modifier modifierS95 = new Modifier("Bitter Gourd", "苦瓜", "", 0.00, seafood9);
		Modifier modifierS96 = new Modifier("Winter Melon", "冬瓜", "", 0.00, seafood9);
		Modifier modifierS97 = new Modifier("Szechuan Vegetable", "四川菜", "", 0.00, seafood9);
		...
		Modifier modifierS101 = new Modifier("Herbal", "药材", "", 0.00, seafood10);
		...
		Modifier modifierS111 = new Modifier("Herbal", "药材", "", 0.00, seafood11);
		Modifier modifierS112 = new Modifier("Winter Melon + Corn", "冬瓜加玉米", "", 0.00, seafood11);
		...
		Food fishBeehoonfood2 = new Food("Fish Soup With Rice", "鱼汤与饭", "add bittergourd: $0.50",
				4.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627042/Food%20Images%20Raw/fishsoup_with_rice.jpg",
				null, fishBeehoonStall);
		Food fishBeehoonfood3 = new Food("Fried Fish Soup With Beehoon", "炸鱼汤与米粉",
				"add bittergourd: $0.50", 5.00,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627090/Food%20Images%20Raw/Fried_Fish_soup_with_Beehoon.jpg",
				null, fishBeehoonStall);

		Food fishBeehoonfood4 = new Food("Fish Soup", "鱼汤", "add bittergourd: $0.50", 3.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458374052/Food%20Images%20Raw/Fish_soup.jpg",
				null, fishBeehoonStall);
		...
		Modifier modifier22 = new Modifier("Add bittergourd", "加苦瓜", "", 0.50, fishBeehoonfood1);
		...
		Modifier modifier23 = new Modifier("Add bittergourd", "加苦瓜", "", 0.50, fishBeehoonfood2);
		...
		Modifier modifier24 = new Modifier("Add bittergourd", "加苦瓜", "", 0.50, fishBeehoonfood3);
		...
		Modifier modifierNew25 = new Modifier("Add bittergourd", "加苦瓜", "", 0.50, fishBeehoonfood4);
		...
		Modifier modifierNew26 = new Modifier("Add bittergourd", "加苦瓜", "", 0.50, fishBeehoonfood5);
		...
		Food appleJuice = new Food("Apple Juice", "苹果汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456555990/Food%20Images%20Raw/Apple_juice.jpg",
				null, fruitStall);
		...
		Food watermelonJuice = new Food("Watermelon Juice", "西瓜汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1457084066/Food%20Images%20Raw/Watermelon_juice.jpg",
				null, fruitStall);
		...
		Food dragonfruitJuice = new Food("Dragonfruit Juice", "龙珠果汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456420619/Food%20Images%20Raw/Dragonfruit_juice.jpg",
				null, fruitStall);
		...
		Food pearJuice = new Food("Pear Juice", "梨汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1458037645/Food%20Images%20Raw/Pear_juice_2.jpg",
				null, fruitStall);
		...
		Food honeydewJuice = new Food("Honeydew Juice", "哈蜜瓜汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456420631/Food%20Images%20Raw/Honeydew_juice.jpg",
				null, fruitStall);
		...
		Food papayaJuice = new Food("Papaya Juice", "木瓜汁", "", 2.60,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456847809/Food%20Images%20Raw/Papaya_juice.jpg",
				null, fruitStall);
		...
		Food pineappleJuice = new Food("Pineapple Juice", "黄梨汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1457059123/Food%20Images%20Raw/Pineapple_juice.jpg",
				null, fruitStall);
		...
		Food bananaJuice = new Food("Banana Juice", "香蕉汁", "", 2.60,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1457155104/Food%20Images%20Raw/Banana_juice.jpg",
				null, fruitStall);
		...
		Food orange = new Food("Orange", "橙", "", 0.60,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1455627100/Food%20Images%20Raw/orange.jpg",
				null, fruitStall);

		Food orangeJuice = new Food("Orange Juice", "橙汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456555997/Food%20Images%20Raw/Orange_juice.jpg",
				null, fruitStall);
		...
		Food guavaJuice = new Food("Guava Juice", "番石榴汁", "", 2.50,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1456555994/Food%20Images%20Raw/Guava_Juice.jpg",
				null, fruitStall);
		...
		Food sarawakPineappleJuice = new Food("Sarawak Pineapple Juice", "沙捞越黄梨果汁", "", 3.10,
				"http://res.cloudinary.com/dmeln4k8n/image/upload/v1457059123/Food%20Images%20Raw/Pineapple_juice.jpg",
				null, fruitStall);
		...
		Modifier modifier36 = new Modifier("Mixed fruits upsize", "果盘加大", "", 0.50, mixedFruits);
		Set<Modifier> modifierList25 = new HashSet<Modifier>();
		modifierList25.add(modifier36);
		mixedFruits.setModifierList(modifierList25);

		Modifier modifierNew24 = new Modifier("Add powder", "加酸梅粉", "", 0.00, guava);
		...
		OrderPeriod period = new OrderPeriod(new DateTime(2015, 12, 2, 16, 36, 0),
				new DateTime(2015, 12, 31, 16, 36, 0), company, canteen1,

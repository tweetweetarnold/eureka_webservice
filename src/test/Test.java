...
public class Test {
	...
	public static void main(String[] args) {
		...
		Stall stall1 = new Stall("Sliced Fish Bee Hoon Stall", "123", "Fish Slice Bee Hoon", 91379160, null,
		new Date(), null);
		...
		new Date(), null);
		Food food9 = new Food("Indian Chicken Set","",3.50,stall5,new Date());
		Food food10 = new Food("Indian Fish Set","",3.50,stall5,new Date());
		...
		Stall stall6 = new Stall("Roast Duck & Chicken Rice Stall", "123", "Roast Duck & Chicken Rice Stall", 98427347, null,
		new Date(), null);
		...
		Stall stall7 = new Stall("REX(Halal)", "123", "REX(Halal)", 62684806, null,
		new Date(), null);
		...
		Stall stall9 = new Stall("Minced Meat Noodles Stall(Closed On Tuesday)", "123", "Minced Meat Noodles Stall(Closed On Tuesday)", 93686070, null,
		new Date(), null);
		...
		Stall stall11 = new Stall("Fruit Stall", "123", "Fruit Stall", 91151608, null,
		new Date(), null);
		...
		Stall kuehStall = new Stall("kuehStall","123","OasisKuehStall",90685620,canteen1,new Date(),null);
		...
		Stall malayStall = new Stall("malayStall", "123", "OasisMalayStall", 93848341,canteen1,new Date(),null);
		...
		Stall indianStall = new Stall("indianStall", "123", "IndianStall", 98717752,canteen1,new Date(),null);
		...
		Stall chineseMixVegStall = new Stall("chineseStall", "123", "OasisChineseMixVegStall", 93848341,canteen1,new Date(),null);
		Food mixVegRice1 = new Food("mix veg rice","ask for more meat, less fried meat, $3.50",3.00, chineseMixVegStall,new Date());
		...
		Stall roastMeatStall = new Stall("roastMeatStall", "123", "RoastMeatStall", 123,canteen1,new Date(),null);
		...
		Stall seafoodTzeCharStall = new Stall("tzeCharStall", "123", "seafoodTzeCharStall", 92262376,canteen1,new Date(),null);
		...
		Food seafood4 = new Food("daily soup with rice and egg", "damn nice", 4.80, seafoodTzeCharStall, new Date());
		...
		Stall fishBeehoonStall = new Stall("fishBeehoonStall", "123", "fishBeehoonStall", 98367790,canteen1,new Date(),null);
		Food fishBeehoonfood1 = new Food("beehoon", "add bittergourd: $0.50", 3.50, fishBeehoonStall, new Date());
		Food fishBeehoonfood2 = new Food("rice", "add bittergourd: $0.50", 4.00, fishBeehoonStall, new Date());
		Food fishBeehoonfood3 = new Food("fried fish", "add bittergourd: $0.50", 5.00, fishBeehoonStall, new Date());
		...
		Stall fruitStall = new Stall("fruitStall", "123", "fruitStall", 91151608,canteen1,new Date(),null);
		...
		Food sarawakPineapple = new Food("sarawakPineapple","damn nice", 1.00, fruitStall, new Date());
		Food mixedFruits = new Food("mixedFruits","damn nice", 3.00, fruitStall, new Date());
		Food largeMixedFruits = new Food("largeMixedFruits","damn nice", 3.50, fruitStall, new Date());
...
//		Gson gson = new GsonBuilder().registerTypeAdapter(arg0, arg1);
		...
		MyConnection.save(stall);
		MyConnection.save(food);
>>>>>>> d9b94204b888105bf1e7e90aff062c1e6f44c3b3

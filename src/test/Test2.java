...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		Food food3 = new Food("Malay Chicken Rice", "", 3.00, stall2, new Date());
		Food food4 = new Food("Malay Fish Rice", "", 3.00, stall2, new Date());
		Food food5 = new Food("Malay Mutton Rice", "", 3.00, stall2, new Date());
		...
		Stall stall6 = new Stall("Roast Duck & Chicken Rice Stall", "123", "Roast Duck & Chicken Rice Stall", 98427347,
				null, new Date(), null);
		Food food13 = new Food("Roast Chicken Rice", "add charseiw/roastmeat 3.00", 2.50, stall6, new Date());
		...
		food5.setModifierList(modifierListA16);
		...
		Food infood3 = new Food("Briyani", "damn nice", 5.00, indianStall, new Date());
		...
		Stall chineseMixVegStall = new Stall("Chinese Stall", "123", "Oasis Chinese Mix Veg Stall", 93848341, canteen1,
				new Date(), null);
		Food mixVegRice1 = new Food("Mix Veg Rice", "ask for more vegetables, less fried meat, $3.50", 3.00,
		...
		Food roastfood2 = new Food("Wanton Mee", "damn nice", 3.20, roastMeatStall, new Date());
		Food roastfood3 = new Food("CharSiew Rice", "damn nice", 3.20, roastMeatStall, new Date());
		Food roastfood4 = new Food("Roast Meat Rice", "damn nice", 3.20, roastMeatStall, new Date());

		// for roastfood1 modifiers
		Modifier modifier12 = new Modifier("2 Meat choices", "add charsiew", 1.00, roastfood1, new Date());
		Modifier modifier13 = new Modifier("2 Meat choices", "add roast meat", 1.00, roastfood1, new Date());
		...
		Modifier modifier14 = new Modifier("2 Meat choices", "add roast chicken", 1.00, roastfood3, new Date());
		Modifier modifier15 = new Modifier("2 Meat choices", "add roast meat", 1.00, roastfood3, new Date());
		...
		Modifier modifier16 = new Modifier("2 Meat choices", "add charsiew", 1.00, roastfood4, new Date());
		Modifier modifier17 = new Modifier("2 Meat choices", "add roast chicken", 1.00, roastfood4, new Date());
		...
		Food seafood1 = new Food("Hor Fun", "damn nice", 3.70, seafoodTzeCharStall, new Date());
		Food seafood2 = new Food("Fried Rice", "damn nice", 4.00, seafoodTzeCharStall, new Date());
		Food seafood3 = new Food("Daily Soup With Rice And Egg", "damn nice", 4.80, seafoodTzeCharStall, new Date());
		...
		Stall fishBeehoonStall = new Stall("Fish Bee Hoon Stall", "123", "Fish Bee Hoon Stall", 98367790, canteen1,
				new Date(), null);
		Food fishBeehoonfood1 = new Food("Fish Bee Hoon", "add bittergourd: $0.50", 3.50, fishBeehoonStall, new Date());
		Food fishBeehoonfood2 = new Food("Fish Bee Hoon Rice", "add bittergourd: $0.50", 4.00, fishBeehoonStall,
				new Date());
		Food fishBeehoonfood3 = new Food("Fried Fish Bee Hoon", "add bittergourd: $0.50", 5.00, fishBeehoonStall,
				new Date());
		...
		Food agaragar = new Food("Agar Agar", "damn nice", 0.60, fruitStall, new Date());
		...
		Food sarawakPineapple = new Food("Sarawak Pineapple", "damn nice", 1.00, fruitStall, new Date());
		Food mixedFruits = new Food("Mixed Fruits", "Upsize $3.50", 3.00, fruitStall, new Date());

		Modifier modifier25 = new Modifier("Mixed fruits upsize", "", 0.50, mixedFruits, new Date());
		Set<Modifier> modifierList14 = new HashSet<Modifier>();
		modifierList14.add(modifier25);
		mixedFruits.setModifierList(modifierList14);
